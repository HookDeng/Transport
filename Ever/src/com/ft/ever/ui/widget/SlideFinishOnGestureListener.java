...
//			//slide to left
//			if (context instanceof AbsSubActivity||context instanceof GestureLoginActivity||context instanceof ManageFinanceBidSuccessActivity) {
...
//			if (context instanceof AbsSubActivity||context instanceof GestureLoginActivity||context instanceof ManageFinanceBidSuccessActivity||context instanceof FundListInfoActivity||context instanceof ManageFinanceListInfoActivity||context instanceof ManageFinanceInfoActivity) {
////				((ImageViewer4GifActivity)context).onBackPressed();
//			} else {
//			}
			((FTActivity)context).doFinish();
			((FTActivity)context).overridePendingTransition(R.anim.hold,R.anim.activity_right_out);
			return true;
		}
