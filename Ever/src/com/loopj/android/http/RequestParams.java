...
public class RequestParams {
    ...
    private static Charset UTF8 = Charset.forName(ENCODING);

    private FileUploadProgressEntity.ProgressListener mProgressListener;
...
//    protected ConcurrentHashMap<String, File> fileParams;
    ...
    public void setProgressListener(FileUploadProgressEntity.ProgressListener listener) {
