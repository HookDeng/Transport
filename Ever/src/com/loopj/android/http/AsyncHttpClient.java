...
public class AsyncHttpClient {
    ...
    static AsyncHttpClient meHC;
    
    public static AsyncHttpClient getIntance(){
    	return meHC==null?meHC=new AsyncHttpClient():meHC;
    }
    ...
    public AsyncHttpClient() {
        ...
        HttpProtocolParams.setUserAgent(httpParams, "Atourong(Android 1.0)");

        SchemeRegistry schemeRegistry = new SchemeRegistry();
        schemeRegistry.register(new Scheme("http", PlainSocketFactory.getSocketFactory(), 80));
        schemeRegistry.register(new Scheme("https", SSLSocketFactory.getSocketFactory(), 443));
        ThreadSafeClientConnManager cm = new ThreadSafeClientConnManager(httpParams, schemeRegistry);
        SSLSocketFactory.getSocketFactory().setHostnameVerifier(new AllowAllHostnameVerifier());//解决hostname in certificate didn't match  
